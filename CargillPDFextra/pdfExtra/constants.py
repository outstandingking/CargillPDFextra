...
vat_entity_map = {
    ...
    "22": "simple_adjusted_after_inspection_tax",
    "23": "reduction_payable_tax",
    "应纳税额减征额": "reduction_payable_tax",
    "应纳税额合计": "payable_sum_tax",
    "应纳税额合计(24=19+21-23)": "payable_sum_tax",
    "24=19+21-23":"payable_sum_tax",
    "期初未缴税额(多缴为负数)": "beginning_term_back_tax",
    "期初未缴税额（多缴为负数）" :"beginning_term_back_tax",
    "25": "beginning_term_back_tax",
    "26": "actual_export_receipt_covering_warrant_return_tax",
    ...
    "27=28+29+30+31": "current_term_paid_tax",
    "分次预缴税额": "stage_prepaid_tax",
    "28":"stage_prepaid_tax",
    "①分次预缴税额":"stage_prepaid_tax",
